...
from .models import Arrears, Payment, TenantNotification, UtilityCharge


@admin.register(Payment)
class PaymentAdmin(admin.ModelAdmin):
    list_display = ("tenant", "amount", "payment_type", "payment_date", "source", "period_month", "period_year")
...
class UtilityChargeAdmin(admin.ModelAdmin):
    list_display = ("tenant", "label", "posting_date", "period_month", "period_year", "units", "amount")
