...
export default function PaymentsPage() {
  ...
  const {
    ...
    defaultValues: {
      ...
      period_month: searchParams.get("month") ? Number(searchParams.get("month")) : now.getMonth() + 1,
      period_year: searchParams.get("year") ? Number(searchParams.get("year")) : now.getFullYear(),
      source: "cash",
      payment_type: "rent",
      reference: "",
      notes: "",
